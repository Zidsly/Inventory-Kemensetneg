                        ...
                        <!--Tabel Data Stok Barang-->
                          ...
                          <!--    <th>Id Barang</th>  -->
                              ...
                              <tbody>
                                ...
                                $query = "SELECT tb_barang.id_barang, tb_barang.nama, tb_barang.kode_barang, tb_cek_stok.jumlah_stok_akhir FROM tb_barang
                                          JOIN tb_cek_stok ON tb_barang.id_barang = tb_cek_stok.id_barang";
