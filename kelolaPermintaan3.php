                    ...
                    <div class="card-body">
                      ...
                      <table id="example2" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                          ...
                          $query = "SELECT tb_order.id_transaksi, tb_user.nama_lengkap, GROUP_CONCAT(tb_barang.nama SEPARATOR '<br>') AS nama, tb_order.tgl_siap, GROUP_CONCAT(tb_order_detail.jumlah_minta SEPARATOR '<br>') AS jumlah_minta, tb_order.status
                          FROM tb_order
                          ...
                          WHERE tb_order.status = 'Siap Diambil'
